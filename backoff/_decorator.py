...
def on_predicate(wait_gen: _WaitGenerator,
                 ...
                 *,
                 ...
                 on_backoff: Optional[_HandlerPredicate] = None,
...
def on_exception(wait_gen: _WaitGenerator,
                 ...
                 *,
                 ...
                 on_success: Optional[_HandlerDetails] = None,
                 on_backoff: Optional[_HandlerDetails] = None,
                 on_giveup: Optional[_HandlerDetails] = None,
                 logger: _MaybeLogger = 'backoff',
                 backoff_log_level: int = logging.INFO,
                 giveup_log_level: int = logging.ERROR,
                 **wait_gen_kwargs: Any) -> Callable[[_CallableT], _CallableT]:
